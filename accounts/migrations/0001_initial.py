    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_image', models.ImageField(blank=True, null=True, upload_to='images/user/')),
                ...
                ('temp_email', models.EmailField(blank=True, default=None, max_length=255, null=True)),
                ('forgot_password_token', models.SlugField(blank=True, null=True, unique=True)),
